...
import { CreateProductDto, Product, ProductPagedResultDto } from "./product";
...
export class ProductService {
   ...
   * @return Success
   */
  getAll(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ProductPagedResultDto> {
    ...
    return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
      ...
      if (response_ instanceof HttpResponseBase) {
        try {
          ...
          return _observableThrow(e) as any as Observable<ProductPagedResultDto>;
        }
      } else
        return _observableThrow(response_) as any as Observable<ProductPagedResultDto>;
    }));
  }
  ...
  /**
     ...
     * @return Success
     */
  get(id: number | undefined): Observable<Product> {
  ...
  create(body: CreateProductDto | undefined): Observable<Product> {
