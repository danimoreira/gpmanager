...
using GpManager.Models.TokenAuth;
...
{
    public abstract class GpManagerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GpManagerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GpManagerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GpManagerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GpManagerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GpManagerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GpManagerDbContext, Task<T>> func)
        {
            T result;
